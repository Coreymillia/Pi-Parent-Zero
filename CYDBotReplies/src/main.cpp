/**
 * PiParent CYD Display — Per-device row pages (NON-INVERTED)
 *
 * Hardware: ESP32-2432S028 "Cheap Yellow Display" — standard panel
 *   - ILI9341 320x240 TFT (landscape)
 *   - XPT2046 resistive touch with IRQ
 *
...
// ---- Display pins (CYD standard) — hardware SPI, non-inverted panel ----
#define GFX_BL 21
...
// Tries to stay on the same device title after a refresh.
